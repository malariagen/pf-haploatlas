...
with st.sidebar:
    ...
    st.header("**Genes**")
    st.markdown("The Mutation Discovery App uses **???** genes, according to the **???** version of the 3D7 Pf genome from [PlasmoDB](https://plasmodb.org/plasmo/app/). All genes have a unique identifier, e.g. **PF3D7_XXXXXXX**, and in some cases a gene name, e.g. **MDR1**.")
    st.header("**Plots**")
