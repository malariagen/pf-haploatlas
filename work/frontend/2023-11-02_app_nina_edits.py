...
st.markdown('<span style="color: blue;">We should add a brief description of the app/data here, and provide links as necessary (e.g. to Pf7 resources</span>', unsafe_allow_html=True)
st.markdown("**Search for a gene, or select a gene from the dropdown list to get started.**")
...
# Create a Streamlit selectbox with the full list of gene names
