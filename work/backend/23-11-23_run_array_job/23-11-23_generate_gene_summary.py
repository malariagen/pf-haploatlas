...
"""
bsub -J “gene_sums[1-5568]%500” -o output.%J.%I -e error.%J.%I -M6000 -R "select[mem>6000] rusage[mem=6000] span[hosts=1]" -G team342 '/software/isg/languages/Python-3.9.10/bin/python3 generate_gene_summary.py ${LSB_JOBINDEX}'
"""
...
#     print(cds_results['gene_name'])
    ...
    with lzma.open(prep_plot_pickle_fn, 'wb') as file:
        plot_data = (df_haplotypes, df_clonal, df_join, background_ns_changes, gene_name)
